  ...
  console.log(props.arSceneNavigator.viroAppProps.globalState);
    ...
    useEffect(() => {
      if (locationReady && cameraReady) {
        setListener(Geolocation.watchPosition(
          (position) => {
    ...
    const placeArObjects = () => {
      ...
      const points = [{lat: location.latitude+.00001, lng:location.longitude, id:"1", title:"point 1"}, {lat: location.latitude, lng:location.longitude+.00001, id:"2", title:"point 2"}];
